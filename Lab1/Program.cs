    ...
    internal class Lab
    {
        static void Main(string[] args)
        {
            ...
            switch (task)
            {
                //1.2
                case 1:
                    n = enterNumNotIncludingGap(-9, 9);
                    int sum = program.sumLastNums(n);
                ...
                case 2:
                    //1.4
                    n = enterNum();
                    if (program.isPositive(n)) Console.WriteLine("Число " + n + " - положительное.");
                ...
                case 3:
                    ...
                    if (program.isUpperCase(symbol)) Console.WriteLine(symbol + " - заглаваня буква.");
                ...
                case 4:
                    ...
                    a = enterNum();
                    b = enterNum();
                    if (program.isDivisor(a, b)) Console.WriteLine("одно из двух чисел - делитель другого.");
                ...
                case 6:
                    ...
                    x = enterNum();
                    y = enterNum();
                    double answer = program.safeDiv(x, y);
                ...
                case 7:
                    ...
                    x = enterNum();
                    y = enterNum();
                    Console.WriteLine(program.makeDecision(x, y));
                    break;
                ...
                case 8:
                    ...
                    y = enterNum();
                    z = enterNum();
                    if (program.sum3(x, y, z)) Console.WriteLine("два числа в сумме дают третье.");
                ...
                case 11:
                    //3.2
                    x = enterNum();
                    string s = program.reverseListNums(x);
                ...
                case 13:
                    //3.6
                    x = enterNum();
                    if (program.equalNum(x)) Console.WriteLine("все цифры в числе {0} однинаковы.", x);
                ...
                case 16:
                    ...
                    x = enterNum();
                    int index = program.findLast(arr, x);
                ...
                case 17:
                    ...
                    int[] newArr = program.add(arr, x, pos);
                ...
                case 19:
                    ...
                    arr = enterArray();
                    int[] arr2 = enterArray();
                    newArr = program.concat(arr, arr2);
                    for (int i = 0; i < newArr.Length; i++) Console.Write(newArr[i] + " ");
                    break;
                ...
                case 20:
                    //4.10
                    arr = enterArray();
                    newArr = program.deleteNegative(arr);
                    for (int i = 0; i < newArr.Length; i++) Console.Write(newArr[i] + " ");
                    break;
            }
        }
        ...
        {
            int n;
            Console.WriteLine("Введите число меньше {0} или больше {1}: ", left, right);
            while (true)
            {
                var input = Console.ReadLine();
                if (int.TryParse(input, out n) && (n >= right || n <= left)) return n;
        ...
        public void printDays(String x)
        {
            ...
            switch (x)
            {
                ...
                case "воскресенье":
                    break;
                default:
                    Console.Error.WriteLine("это не день недели");
                    break;
            }
        }
